...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { background: @home.background, font: @home.font, label_color: @home.label_color }
    end
  ...
  test "should update home" do
    patch :update, id: @home, home: { background: @home.background, font: @home.font, label_color: @home.label_color }
    assert_redirected_to home_path(assigns(:home))
  end
